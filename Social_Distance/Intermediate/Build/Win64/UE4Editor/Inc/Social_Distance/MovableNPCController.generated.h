...
public: \
	DECLARE_CLASS(AMovableNPCController, AAIController, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Social_Distance"), NO_API) \
...
#define Social_Distance_Source_Social_Distance_MovableNPCController_h_15_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AMovableNPCController); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AMovableNPCController); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AMovableNPCController(AMovableNPCController&&); \
	NO_API AMovableNPCController(const AMovableNPCController&); \
public:
...
template<> SOCIAL_DISTANCE_API UClass* StaticClass<class AMovableNPCController>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Social_Distance_Source_Social_Distance_MovableNPCController_h
