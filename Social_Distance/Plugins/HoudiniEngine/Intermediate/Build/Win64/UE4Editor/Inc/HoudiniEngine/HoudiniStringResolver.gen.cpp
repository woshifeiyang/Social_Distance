...
static struct FScriptStruct_HoudiniEngine_StaticRegisterNativesFHoudiniAttributeResolver
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniAttributeResolver")),new UScriptStruct::TCppStructOps<FHoudiniAttributeResolver>);
	}
...
static struct FScriptStruct_HoudiniEngine_StaticRegisterNativesFHoudiniStringResolver
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniStringResolver")),new UScriptStruct::TCppStructOps<FHoudiniStringResolver>);
	}
