...
static struct FScriptStruct_HoudiniEngine_StaticRegisterNativesFHoudiniPDGImportBGEOResultMessage
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniPDGImportBGEOResultMessage")),new UScriptStruct::TCppStructOps<FHoudiniPDGImportBGEOResultMessage>);
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FHoudiniPDGImportBGEOResultMessage_Hash() { return 639084373U; }
...
static struct FScriptStruct_HoudiniEngine_StaticRegisterNativesFHoudiniPDGImportNodeOutput
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniPDGImportNodeOutput")),new UScriptStruct::TCppStructOps<FHoudiniPDGImportNodeOutput>);
	}
...
static struct FScriptStruct_HoudiniEngine_StaticRegisterNativesFHoudiniPDGImportNodeOutputObject
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniPDGImportNodeOutputObject")),new UScriptStruct::TCppStructOps<FHoudiniPDGImportNodeOutputObject>);
	}
...
static struct FScriptStruct_HoudiniEngine_StaticRegisterNativesFHoudiniGenericAttributes
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniGenericAttributes")),new UScriptStruct::TCppStructOps<FHoudiniGenericAttributes>);
	}
...
static struct FScriptStruct_HoudiniEngine_StaticRegisterNativesFHoudiniPDGImportBGEOMessage
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniPDGImportBGEOMessage")),new UScriptStruct::TCppStructOps<FHoudiniPDGImportBGEOMessage>);
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FHoudiniPDGImportBGEOMessage_Statics::NewProp_StaticMeshGenerationProperties_MetaData[] = {
		{ "Comment", "// Settings used during static mesh generation\n" },
		{ "ModuleRelativePath", "Private/HoudiniPDGImporterMessages.h" },
		{ "ToolTip", "Settings used during static mesh generation" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHoudiniPDGImportBGEOMessage_Statics::NewProp_StaticMeshGenerationProperties = { "StaticMeshGenerationProperties", nullptr, (EPropertyFlags)0x0010008000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHoudiniPDGImportBGEOMessage, StaticMeshGenerationProperties), Z_Construct_UScriptStruct_FHoudiniStaticMeshGenerationProperties, METADATA_PARAMS(Z_Construct_UScriptStruct_FHoudiniPDGImportBGEOMessage_Statics::NewProp_StaticMeshGenerationProperties_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHoudiniPDGImportBGEOMessage_Statics::NewProp_StaticMeshGenerationProperties_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FHoudiniPDGImportBGEOMessage_Statics::NewProp_MeshBuildSettings_MetaData[] = {
		{ "Comment", "// Static mesh build settings used during mesh builds\n" },
		{ "ModuleRelativePath", "Private/HoudiniPDGImporterMessages.h" },
		{ "ToolTip", "Static mesh build settings used during mesh builds" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHoudiniPDGImportBGEOMessage_Statics::NewProp_MeshBuildSettings = { "MeshBuildSettings", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHoudiniPDGImportBGEOMessage, MeshBuildSettings), Z_Construct_UScriptStruct_FMeshBuildSettings, METADATA_PARAMS(Z_Construct_UScriptStruct_FHoudiniPDGImportBGEOMessage_Statics::NewProp_MeshBuildSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHoudiniPDGImportBGEOMessage_Statics::NewProp_MeshBuildSettings_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FHoudiniPDGImportBGEOMessage_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FHoudiniPDGImportBGEOMessage_Statics::NewProp_StaticMeshGenerationProperties,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FHoudiniPDGImportBGEOMessage_Statics::NewProp_MeshBuildSettings,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FHoudiniPDGImportBGEOMessage_Hash() { return 481539602U; }
...
static struct FScriptStruct_HoudiniEngine_StaticRegisterNativesFHoudiniPDGImportBGEODiscoverMessage
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniPDGImportBGEODiscoverMessage")),new UScriptStruct::TCppStructOps<FHoudiniPDGImportBGEODiscoverMessage>);
	}
