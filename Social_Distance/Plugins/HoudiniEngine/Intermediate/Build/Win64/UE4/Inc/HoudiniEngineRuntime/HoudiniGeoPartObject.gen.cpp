...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFHoudiniGeoPartObject
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniGeoPartObject")),new UScriptStruct::TCppStructOps<FHoudiniGeoPartObject>);
	}
...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFHoudiniMeshSocket
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniMeshSocket")),new UScriptStruct::TCppStructOps<FHoudiniMeshSocket>);
	}
...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFHoudiniCurveInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniCurveInfo")),new UScriptStruct::TCppStructOps<FHoudiniCurveInfo>);
	}
...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFHoudiniVolumeInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniVolumeInfo")),new UScriptStruct::TCppStructOps<FHoudiniVolumeInfo>);
	}
...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFHoudiniPartInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniPartInfo")),new UScriptStruct::TCppStructOps<FHoudiniPartInfo>);
	}
...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFHoudiniGeoInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniGeoInfo")),new UScriptStruct::TCppStructOps<FHoudiniGeoInfo>);
	}
...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFHoudiniObjectInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniObjectInfo")),new UScriptStruct::TCppStructOps<FHoudiniObjectInfo>);
	}
