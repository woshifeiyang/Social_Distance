...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFAggregatedWorkItemTally
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("AggregatedWorkItemTally")),new UScriptStruct::TCppStructOps<FAggregatedWorkItemTally>);
	}
...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFWorkItemTallyBase
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("WorkItemTallyBase")),new UScriptStruct::TCppStructOps<FWorkItemTallyBase>);
	}
