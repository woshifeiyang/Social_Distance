...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFHoudiniGenericAttribute
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniGenericAttribute")),new UScriptStruct::TCppStructOps<FHoudiniGenericAttribute>);
	}
...
static struct FScriptStruct_HoudiniEngineRuntime_StaticRegisterNativesFHoudiniGenericAttributeChangedProperty
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("HoudiniGenericAttributeChangedProperty")),new UScriptStruct::TCppStructOps<FHoudiniGenericAttributeChangedProperty>);
	}
