...
{
	// Happiness Level
	if(GameInstance->MC_Happiness <= 100.0f && GameInstance->MC_Happiness > 80.0f)
	{
		const FString String = "<TitleText>Very Happy</>";
		Happiness_Level->SetText(FText::FromString(String));
	}else if(GameInstance->MC_Happiness <= 80.0f && GameInstance->MC_Happiness > 60.0f)
	{
		const FString String = "<TitleText>Happy</>";
		Happiness_Level->SetText(FText::FromString(String));
	}else if(GameInstance->MC_Happiness <= 60.0f && GameInstance->MC_Happiness > 40.0f)
	{
		const FString String = "<TitleText>Neutral</>";
		Happiness_Level->SetText(FText::FromString(String));
	}else if(GameInstance->MC_Happiness <= 40.0f && GameInstance->MC_Happiness > 20.0f)
	{
		const FString String = "<TitleText>Lonely</>";
		Happiness_Level->SetText(FText::FromString(String));
	}else if(GameInstance->MC_Happiness <= 20.0f && GameInstance->MC_Happiness >= 0.0f)
	{
		const FString String = "<TitleText>Very Lonely</>";
		Happiness_Level->SetText(FText::FromString(String));
	}
	// Risk Level
	if(GameInstance->MC_Risk >= 0.0f && GameInstance->MC_Risk < 20.0f)
	{
		const FString String = "<TitleText>Very Low</>";
		Risk_Level->SetText(FText::FromString(String));
	}else if(GameInstance->MC_Risk >= 20.0f && GameInstance->MC_Risk < 40.0f)
	{
		const FString String = "<TitleText>Low</>";
		Risk_Level->SetText(FText::FromString(String));
	}else if(GameInstance->MC_Risk >= 40.0f && GameInstance->MC_Risk < 60.0f)
	{
		const FString String = "<TitleText>Medium</>";
		Risk_Level->SetText(FText::FromString(String));
	}else if(GameInstance->MC_Risk >= 60.0f && GameInstance->MC_Risk < 80.0f)
	{
		const FString String = "<TitleText>High</>";
		Risk_Level->SetText(FText::FromString(String));
	}else if(GameInstance->MC_Risk >= 80.0f && GameInstance->MC_Risk <= 100.0f)
	{
	...
	// NPC who has Covid
	FString String;
	for(auto Element : GameInstance->NPC_Data)
	{
